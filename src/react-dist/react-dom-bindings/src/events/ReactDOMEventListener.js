...
export var _enabled = true; // This is exported in FB builds for use by legacy FB layer infra.
...
export var return_targetInst = null; // Returns a SuspenseInstance or Container if it's blocked.
